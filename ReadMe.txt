...
-- Hierarchal changes (Interests page split into Novels and Traveling)
...
-- JSON data for Travel influencer added and fetched on page
...
Interests -> Traveling: Content about places and inspiring individuals.
...
Visit the Traveling page to select and view Inspiring Traveler information
